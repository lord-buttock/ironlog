...
const IRON_EXERCISES = {
  ...
  iron_kas_bridge: { name: 'Kas Glute Bridge', muscle: 'Glutes', unit: 'kg', defaultSets: 4, defaultDuration: 60, defaultReps: 12, cue: 'Like a glute bridge but with very small ROM — do not lock out at the top. Keep constant glute tension throughout. Slow, deliberate pace. Weight across hips.', demo: YT('kas+glute+bridge+tutorial+constant+tension') },
  ...
  iron_squat_pulse: { name: 'Bodyweight Squat Pulse', muscle: 'Quads', unit: 'bw', defaultSets: 4, defaultDuration: 60, defaultReps: 12, cue: 'Stay at the bottom of a squat and pulse up and down through a very small range. Maintain tension throughout — do not stand up. Burn-out finisher for quads.', demo: YT('squat+pulse+bodyweight+legs+burnout+tutorial') },
  ...
  iron_db_row: { name: 'Bent-Over DB Row', muscle: 'Lats', unit: 'kg', defaultSets: 4, defaultDuration: 60, defaultReps: 12, cue: 'Hinge forward at hips, flat back. Both DBs hang below chest. Pull elbows back and up, squeezing shoulder blades. Control the descent. Core braced throughout.', demo: YT('bent+over+dumbbell+row+both+arms+form+tutorial') },
  iron_pronated_row: { name: 'Pronated (Palms Down) Row', muscle: 'Lats', unit: 'kg', defaultSets: 4, defaultDuration: 60, defaultReps: 12, cue: 'Overhand grip (palms facing you as you hinge). Pull elbows back. Overhand grip increases upper back and rear delt engagement compared to underhand. Flat back throughout.', demo: YT('pronated+overhand+dumbbell+row+back+tutorial') },
  iron_supinated_row: { name: 'Supinated (Palms Up) Row', muscle: 'Lats', unit: 'kg', defaultSets: 4, defaultDuration: 60, defaultReps: 12, cue: 'Underhand grip (palms facing ceiling as you hinge). Pull elbows back close to body. Underhand grip increases bicep involvement compared to overhand. Flat back throughout.', demo: YT('supinated+underhand+dumbbell+row+bicep+back+tutorial') },
  ...
  iron_zottman: { name: 'Zottman Curl', muscle: 'Biceps', unit: 'kg', defaultSets: 4, defaultDuration: 60, defaultReps: 12, cue: 'Curl up with supinated (palms up) grip, rotate to pronated (palms down) at top, lower slowly with pronated grip. Trains biceps on the way up and forearms on the way down.', demo: YT('zottman+curl+dumbbell+tutorial+bicep+forearm') },
  ...
  iron_lying_ham_curl: { name: 'Lying DB Hamstring Curl', muscle: 'Hamstrings', unit: 'kg', defaultSets: 4, defaultDuration: 60, defaultReps: 12, cue: 'Lie face down, feet together squeezing a single DB between them. Curl DB toward glutes, hold briefly, lower with control. Light weight — squeeze the hamstrings, no momentum.', demo: YT('lying+dumbbell+hamstring+curl+feet+squeeze+tutorial') },
  ...
  iron_rear_delt_row: { name: 'Rear Delt Row', muscle: 'Rear Delts', unit: 'kg', defaultSets: 4, defaultDuration: 60, defaultReps: 12, cue: 'Hinge forward, elbows flare wide as you pull. Target is to get elbows level with shoulders. Lead with elbows, not hands. Targets posterior deltoid rather than lats.', demo: YT('rear+delt+row+dumbbell+hinge+elbow+flare+tutorial') },
  iron_front_raise: { name: 'Front DB Raise', muscle: 'Front Delts', unit: 'kg', defaultSets: 4, defaultDuration: 60, defaultReps: 12, cue: 'Straight arms, raise DBs to shoulder height in front. Control the descent — no momentum. Light weight only. Can alternate arms to manage fatigue.', demo: YT('front+dumbbell+raise+shoulder+tutorial+form') },
  ...
  iron_squat_hold: { name: 'Squat Isometric Hold', muscle: 'Quads', unit: 'bw', defaultSets: 4, defaultDuration: 60, defaultReps: 12, cue: 'Lower to squat position and hold. Thighs parallel to floor or as low as comfortable. Chest up, weight through heels. Static hold — no pulsing, no movement.', demo: YT('squat+isometric+hold+wall+sit+quad+tutorial') },
  ...
  iron_plank_tap: { name: 'High Plank Hand Tap', muscle: 'Abs', unit: 'bw', defaultSets: 4, defaultDuration: 60, defaultReps: 12, cue: 'High plank position. Tap opposite hand to opposite shoulder alternately while keeping hips still. Resist rotation — brace core hard. Slow and controlled.', demo: YT('high+plank+shoulder+tap+anti+rotation+core+tutorial') },
  iron_b_stance_hip_thrust: { name: 'B-Stance Hip Thrust', muscle: 'Glutes', unit: 'kg', defaultSets: 4, defaultDuration: 60, defaultReps: 12, perSide: true, cue: 'Most load on the front leg. Rear foot just touches floor for balance only. Drive through front heel. One glute does most of the work. Back supported on bench edge.', demo: YT('b+stance+hip+thrust+single+leg+glute+dumbbell+tutorial') },
  iron_tricep_kickback: { name: 'Tricep Kickback', muscle: 'Triceps', unit: 'kg', defaultSets: 4, defaultDuration: 60, defaultReps: 12, cue: 'Hinge forward, upper arm parallel to floor and pinned to torso. Extend forearm back until arm is straight, squeezing tricep at top. Control return. No swinging.', demo: YT('tricep+kickback+dumbbell+form+tutorial+isolation') },
  iron_shrug: { name: 'DB Shrug', muscle: 'Upper Traps', unit: 'kg', defaultSets: 4, defaultDuration: 60, defaultReps: 12, cue: 'Dumbbells at sides. Shrug shoulders straight up toward ears, hold 1 second at top, lower with control. No neck rolling — straight up and down only.', demo: YT('dumbbell+shrug+upper+trap+form+tutorial') },
  ...
  iron_glute_bridge: { name: 'Glute Bridge Hold', muscle: 'Glutes', unit: 'bw', defaultSets: 4, defaultDuration: 60, defaultReps: 12, cue: 'Floor-based bridge. Drive hips up to full extension and hold, or perform small pulsing movements. No bench needed. Used as the hold/isometric partner in superset pairs.', demo: YT('glute+bridge+hold+isometric+floor+tutorial') },
};
