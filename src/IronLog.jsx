...
const PNG_EXERCISE_ICON_IDS = new Set([
  ...
  'iron_suitcase_squat', 'iron_curtsy_lunge',
]);
...
const IRON_EXERCISES = {
  iron_heel_elev_squat: { name: 'Heel-Elevated Squat', muscle: 'Quads', unit: 'kg', defaultSets: 4, defaultDuration: 60, defaultReps: null, isTimed: true, cue: 'Heels raised on yoga block or weight plate. Sit deep into squat, knees track over toes. Upright torso throughout. Drive through quads on the way up.', demo: YT('heel+elevated+squat+dumbbell+tutorial+form') },
  iron_bulgarian_split: { name: 'Bulgarian Split Squat', muscle: 'Quads', unit: 'kg', defaultSets: 4, defaultDuration: 60, defaultReps: null, isTimed: true, perSide: true, cue: 'Rear foot elevated on chair behind you. Lower rear knee toward floor, torso upright. Front foot flat, drive through heel. Keep most weight through the front leg.', caution: 'Slipped disc — stop if lower back rounds or you feel any lumbar discomfort.', demo: YT('bulgarian+split+squat+dumbbell+tutorial+form') },
  iron_kas_bridge: { name: 'Kas Glute Bridge', muscle: 'Glutes', unit: 'kg', defaultSets: 4, defaultDuration: 60, defaultReps: null, isTimed: true, cue: 'Like a glute bridge but with very small ROM — do not lock out at the top. Keep constant glute tension throughout. Slow, deliberate pace. Weight across hips.', demo: YT('kas+glute+bridge+tutorial+constant+tension') },
  iron_sl_rdl: { name: 'Single-Leg RDL', muscle: 'Hamstrings', unit: 'kg', defaultSets: 4, defaultDuration: 60, defaultReps: null, isTimed: true, perSide: true, cue: 'Hinge on one leg, rear leg floats back as counterweight. Neutral spine — no rounding. Light load, focus on the hip hinge and balance. Stop well before hamstring pull.', caution: 'Slipped disc — neutral spine only. Stop if lower back tightens.', demo: YT('single+leg+romanian+deadlift+dumbbell+form+tutorial') },
  iron_bw_kickback: { name: 'Bodyweight Glute Kickback', muscle: 'Glutes', unit: 'bw', defaultSets: 4, defaultDuration: 60, defaultReps: null, isTimed: true, perSide: true, cue: 'On hands and knees. Drive heel toward ceiling, squeezing glute at top. Keep hips square — do not twist. Controlled return. Can add band around thighs.', demo: YT('bodyweight+glute+kickback+quadruped+tutorial') },
  iron_cyclist_squat: { name: 'Cyclist Squat', muscle: 'Quads', unit: 'kg', defaultSets: 4, defaultDuration: 60, defaultReps: null, isTimed: true, cue: 'Very narrow stance, heels elevated on block. Extreme quad isolation. Go deep — the elevated heels allow the knees to travel well forward. Dumbbells held at sides or in goblet position.', demo: YT('cyclist+squat+dumbbell+heel+elevated+quad+tutorial') },
  iron_fwd_lunge: { name: 'Forward Alternating Lunge', muscle: 'Quads', unit: 'kg', defaultSets: 4, defaultDuration: 60, defaultReps: null, isTimed: true, cue: 'Step forward, lower rear knee toward floor. Drive through front heel to return. Alternate legs. More quad-dominant than reverse lunge. Keep torso upright throughout.', demo: YT('forward+alternating+lunge+dumbbell+form+tutorial') },
  iron_1_5_goblet: { name: '1.5 Rep Goblet Squat', muscle: 'Quads', unit: 'kg', defaultSets: 4, defaultDuration: 60, defaultReps: null, isTimed: true, cue: 'Full squat down, rise halfway, lower back down fully, then stand completely = 1 rep. Constant time under tension. Slower tempo than standard goblet squat.', demo: YT('1.5+rep+goblet+squat+time+under+tension+tutorial') },
  iron_squat_pulse: { name: 'Bodyweight Squat Pulse', muscle: 'Quads', unit: 'bw', defaultSets: 4, defaultDuration: 60, defaultReps: null, isTimed: true, cue: 'Stay at the bottom of a squat and pulse up and down through a very small range. Maintain tension throughout — do not stand up. Burn-out finisher for quads.', demo: YT('squat+pulse+bodyweight+legs+burnout+tutorial') },
  iron_b_stance_rdl: { name: 'B-Stance RDL', muscle: 'Hamstrings', unit: 'kg', defaultSets: 4, defaultDuration: 60, defaultReps: null, isTimed: true, perSide: true, cue: 'Staggered stance — front foot takes most of the load. Rear foot touches floor for balance only. Hinge at hip, neutral spine. Most of the work goes through the front leg.', caution: 'Slipped disc — neutral spine only. Stop if lower back tightens.', demo: YT('b+stance+rdl+dumbbell+single+leg+hinge+tutorial') },
  iron_sumo_dl: { name: 'Sumo Deadlift', muscle: 'Glutes', unit: 'kg', defaultSets: 4, defaultDuration: 60, defaultReps: null, isTimed: true, cue: 'Wide stance, toes pointed out 30-45°. Grip DBs between legs. Push knees out in line with toes as you drive up. Neutral spine throughout. Full hip extension at the top.', caution: 'Slipped disc — neutral spine only. Stop immediately if lower back pain.', demo: YT('dumbbell+sumo+deadlift+form+tutorial+glutes') },
  iron_banded_abduct: { name: 'Banded Glute Abduction', muscle: 'Glutes', unit: 'band', defaultSets: 4, defaultDuration: 60, defaultReps: null, isTimed: true, cue: 'Resistance band around thighs just above knees. Seated or lying with knees bent. Push knees apart against band resistance, controlling return. Targets glute medius.', demo: YT('banded+glute+abduction+seated+lying+tutorial') },
  iron_db_row: { name: 'Bent-Over DB Row', muscle: 'Lats', unit: 'kg', defaultSets: 4, defaultDuration: 60, defaultReps: null, isTimed: true, cue: 'Hinge forward at hips, flat back. Both DBs hang below chest. Pull elbows back and up, squeezing shoulder blades. Control the descent. Core braced throughout.', demo: YT('bent+over+dumbbell+row+both+arms+form+tutorial') },
  iron_pronated_row: { name: 'Pronated (Palms Down) Row', muscle: 'Lats', unit: 'kg', defaultSets: 4, defaultDuration: 60, defaultReps: null, isTimed: true, cue: 'Overhand grip (palms facing you as you hinge). Pull elbows back. Overhand grip increases upper back and rear delt engagement compared to underhand. Flat back throughout.', demo: YT('pronated+overhand+dumbbell+row+back+tutorial') },
  iron_supinated_row: { name: 'Supinated (Palms Up) Row', muscle: 'Lats', unit: 'kg', defaultSets: 4, defaultDuration: 60, defaultReps: null, isTimed: true, cue: 'Underhand grip (palms facing ceiling as you hinge). Pull elbows back close to body. Underhand grip increases bicep involvement compared to overhand. Flat back throughout.', demo: YT('supinated+underhand+dumbbell+row+bicep+back+tutorial') },
  iron_pullover: { name: 'DB Pullover', muscle: 'Lats', unit: 'kg', defaultSets: 4, defaultDuration: 60, defaultReps: null, isTimed: true, cue: 'Lie on bench, hold one DB with both hands above chest. Arc slowly behind head, keeping slight bend in elbows. Return to start. Light weight — this is a stretch movement.', caution: 'Shoulder bursitis — use light weight only. Stop if you feel impingement at the stretched (overhead) position.', demo: YT('dumbbell+pullover+lat+stretch+tutorial+form') },
  iron_zottman: { name: 'Zottman Curl', muscle: 'Biceps', unit: 'kg', defaultSets: 4, defaultDuration: 60, defaultReps: null, isTimed: true, cue: 'Curl up with supinated (palms up) grip, rotate to pronated (palms down) at top, lower slowly with pronated grip. Trains biceps on the way up and forearms on the way down.', demo: YT('zottman+curl+dumbbell+tutorial+bicep+forearm') },
  iron_suitcase_squat: { name: 'Suitcase Squat', muscle: 'Quads', unit: 'kg', defaultSets: 4, defaultDuration: 60, defaultReps: null, isTimed: true, cue: 'Feet shoulder-width, DBs held at sides (not goblet position). Squat down keeping torso upright. Resist the urge to lean — maintain a vertical torso throughout.', demo: YT('suitcase+squat+dumbbell+sides+tutorial') },
  iron_curtsy_lunge: { name: 'Curtsy Lunge', muscle: 'Glutes', unit: 'kg', defaultSets: 4, defaultDuration: 60, defaultReps: null, isTimed: true, perSide: true, cue: 'Step one foot behind and across the other (curtsy position). Lower rear knee toward floor. Front knee tracks over toes. Works glutes and abductors. Return to start.', demo: YT('curtsy+lunge+dumbbell+glute+abductor+tutorial') },
  iron_seated_calf: { name: 'Seated Calf Raise', muscle: 'Calves', unit: 'kg', defaultSets: 4, defaultDuration: 60, defaultReps: null, isTimed: true, cue: 'Seated, weight plates or DBs resting on knees. Rise onto balls of feet, hold 1 second at top. Lower fully to feel the stretch at the bottom. Slow, controlled tempo.', demo: YT('seated+calf+raise+dumbbell+knees+tutorial+form') },
  iron_incline_press: { name: 'Incline DB Chest Press', muscle: 'Chest', unit: 'kg', defaultSets: 4, defaultDuration: 60, defaultReps: null, isTimed: true, cue: 'Low incline only (20-30°). Elbows at 45° from body — not flared. Lower to chest, press up. Higher inclines approach overhead pressing angle — stay low.', caution: 'Shoulder bursitis — low incline only (20-30°). Stop if you feel any shoulder impingement.', demo: YT('incline+dumbbell+chest+press+low+incline+form+tutorial') },
  iron_bench_dip: { name: 'Chair / Bench Dip', muscle: 'Triceps', unit: 'bw', defaultSets: 4, defaultDuration: 60, defaultReps: null, isTimed: true, cue: 'Hands on chair edge behind, fingers pointing forward. Lower by bending elbows. Keep elbows pointing straight back — do not flare. Stop range if shoulders feel uncomfortable.', demo: YT('bench+dip+tricep+chair+tutorial+form') },
  iron_hip_hinge_hold: { name: 'Hip Hinge Hold', muscle: 'Hamstrings', unit: 'kg', defaultSets: 4, defaultDuration: 60, defaultReps: null, isTimed: true, cue: 'Hinge at hips with DBs held at thighs. Hold the hinge position isometrically — back flat, slight knee bend, hamstrings loaded. Replaces Good Mornings; eliminates loaded spinal flexion risk.', demo: YT('hip+hinge+hold+isometric+hamstring+tutorial') },
  iron_bw_hyper_ext: { name: 'Bodyweight Back Extension', muscle: 'Glutes', unit: 'bw', defaultSets: 4, defaultDuration: 60, defaultReps: null, isTimed: true, cue: 'Lie prone on mat. Lift chest and legs together (superman position), or just chest if lower back complains. No added load — bodyweight only. Stop if lower back is uncomfortable.', demo: YT('bodyweight+back+extension+prone+superman+tutorial') },
  iron_lying_ham_curl: { name: 'Lying DB Hamstring Curl', muscle: 'Hamstrings', unit: 'kg', defaultSets: 4, defaultDuration: 60, defaultReps: null, isTimed: true, cue: 'Lie face down, feet together squeezing a single DB between them. Curl DB toward glutes, hold briefly, lower with control. Light weight — squeeze the hamstrings, no momentum.', demo: YT('lying+dumbbell+hamstring+curl+feet+squeeze+tutorial') },
  iron_lateral_hold: { name: 'Lateral Raise Hold', muscle: 'Side Delts', unit: 'kg', defaultSets: 4, defaultDuration: 60, defaultReps: null, isTimed: true, cue: 'Hold DBs at shoulder height (arms extended to sides at 90°) for the set duration. Isometric lateral deltoid work. Arms stay at shoulder height — not overhead. Replaces Isometric Overhead Holds.', demo: YT('lateral+raise+isometric+hold+shoulder+height+tutorial') },
  iron_rear_delt_row: { name: 'Rear Delt Row', muscle: 'Rear Delts', unit: 'kg', defaultSets: 4, defaultDuration: 60, defaultReps: null, isTimed: true, cue: 'Hinge forward, elbows flare wide as you pull. Target is to get elbows level with shoulders. Lead with elbows, not hands. Targets posterior deltoid rather than lats.', demo: YT('rear+delt+row+dumbbell+hinge+elbow+flare+tutorial') },
  iron_front_raise: { name: 'Front DB Raise', muscle: 'Front Delts', unit: 'kg', defaultSets: 4, defaultDuration: 60, defaultReps: null, isTimed: true, cue: 'Straight arms, raise DBs to shoulder height in front. Control the descent — no momentum. Light weight only. Can alternate arms to manage fatigue.', demo: YT('front+dumbbell+raise+shoulder+tutorial+form') },
  iron_crossover_stepup: { name: 'Cross-over Step-up', muscle: 'Glutes', unit: 'kg', defaultSets: 4, defaultDuration: 60, defaultReps: null, isTimed: true, perSide: true, cue: 'Step across midline onto bench with one foot. Drive through that hip to step up. The cross pattern emphasises the glute over the quad. Step down slowly and controlled.', demo: YT('crossover+step+up+glute+emphasis+dumbbell+tutorial') },
  iron_squat_hold: { name: 'Squat Isometric Hold', muscle: 'Quads', unit: 'bw', defaultSets: 4, defaultDuration: 60, defaultReps: null, isTimed: true, cue: 'Lower to squat position and hold. Thighs parallel to floor or as low as comfortable. Chest up, weight through heels. Static hold — no pulsing, no movement.', demo: YT('squat+isometric+hold+wall+sit+quad+tutorial') },
  iron_frog_pump: { name: 'Frog Pump', muscle: 'Glutes', unit: 'bw', defaultSets: 4, defaultDuration: 60, defaultReps: null, isTimed: true, cue: 'Lie on back, soles of feet pressed together, knees falling out (frog position). Press hips up using glutes. Small range, constant tension. Bodyweight only — no additional load.', demo: YT('frog+pump+glute+bodyweight+tutorial+form') },
  iron_diamond_pushup: { name: 'Diamond Push-up', muscle: 'Triceps', unit: 'bw', defaultSets: 4, defaultDuration: 60, defaultReps: null, isTimed: true, cue: 'Hands form a diamond shape (index fingers and thumbs touching) on the floor. Lower chest to hands, press back up. Tricep-dominant push-up variation. Modify on knees if needed.', demo: YT('diamond+push+up+tricep+form+tutorial') },
  iron_plank_tap: { name: 'High Plank Hand Tap', muscle: 'Abs', unit: 'bw', defaultSets: 4, defaultDuration: 60, defaultReps: null, isTimed: true, cue: 'High plank position. Tap opposite hand to opposite shoulder alternately while keeping hips still. Resist rotation — brace core hard. Slow and controlled.', demo: YT('high+plank+shoulder+tap+anti+rotation+core+tutorial') },
  iron_b_stance_hip_thrust: { name: 'B-Stance Hip Thrust', muscle: 'Glutes', unit: 'kg', defaultSets: 4, defaultDuration: 60, defaultReps: null, isTimed: true, perSide: true, cue: 'Most load on the front leg. Rear foot just touches floor for balance only. Drive through front heel. One glute does most of the work. Back supported on bench edge.', demo: YT('b+stance+hip+thrust+single+leg+glute+dumbbell+tutorial') },
  iron_tricep_kickback: { name: 'Tricep Kickback', muscle: 'Triceps', unit: 'kg', defaultSets: 4, defaultDuration: 60, defaultReps: null, isTimed: true, cue: 'Hinge forward, upper arm parallel to floor and pinned to torso. Extend forearm back until arm is straight, squeezing tricep at top. Control return. No swinging.', demo: YT('tricep+kickback+dumbbell+form+tutorial+isolation') },
  iron_shrug: { name: 'DB Shrug', muscle: 'Upper Traps', unit: 'kg', defaultSets: 4, defaultDuration: 60, defaultReps: null, isTimed: true, cue: 'Dumbbells at sides. Shrug shoulders straight up toward ears, hold 1 second at top, lower with control. No neck rolling — straight up and down only.', demo: YT('dumbbell+shrug+upper+trap+form+tutorial') },
  iron_overhead_tricep: { name: 'Overhead Tricep Extension', muscle: 'Triceps', unit: 'kg', defaultSets: 4, defaultDuration: 60, defaultReps: null, isTimed: true, cue: 'Hold one or two DBs overhead with both hands. Lower weight behind head by bending elbows, keeping upper arms vertical and close together. Extend back up fully.', demo: YT('overhead+tricep+extension+dumbbell+form+tutorial') },
  iron_pushup: { name: 'Standard Push-up', muscle: 'Chest', unit: 'bw', defaultSets: 4, defaultDuration: 60, defaultReps: null, isTimed: true, cue: 'Hands slightly wider than shoulder-width. Elbows at 45° from body — not flared. Lower chest to floor, press back up. Body in a straight line throughout. Modify on knees if needed.', demo: YT('standard+push+up+form+tutorial+chest+triceps') },
  iron_lean_lateral: { name: 'Lean-Away Lateral Raise', muscle: 'Side Delts', unit: 'kg', defaultSets: 4, defaultDuration: 60, defaultReps: null, isTimed: true, perSide: true, cue: 'Hold a fixed support with one hand, lean away to create a long lever. Raise the free arm out to the side. The lean increases range of motion and stretch at the bottom.', demo: YT('lean+away+lateral+raise+cable+dumbbell+tutorial') },
  iron_glute_bridge: { name: 'Glute Bridge Hold', muscle: 'Glutes', unit: 'bw', defaultSets: 4, defaultDuration: 60, defaultReps: null, isTimed: true, cue: 'Floor-based bridge. Drive hips up to full extension and hold, or perform small pulsing movements. No bench needed. Used as the hold/isometric partner in superset pairs.', demo: YT('glute+bridge+hold+isometric+floor+tutorial') },
};
